...
path_i = r'C:\Users\JF_db\Desktop\database\Customers\Data\upload'
path_f = r'C:\Users\JF_db\Desktop\database\Customers\Data\done'
...
for _ in range(len(os.listdir(path_i))):
    ...
    while u_completed == False:
        ...
        validation = wait_for_confirmation('Customer', 273, 246, 357, 264, time_out=10)
        if validation == False:
            reload(True)
            continue
        time.sleep(1)
        ...
        # time.sleep(0.5)
        pyautogui.click(671, 452) #chage the shop field
        pyautogui.typewrite('mig')
        time.sleep(1)
        pyautogui.click(661, 483)
        time.sleep(1)
