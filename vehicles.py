...
path_i = r'C:\Users\JF_db\Desktop\database\vehicles\Data\upload'
path_f = r'C:\Users\JF_db\Desktop\database\vehicles\Data\done'
...
for _ in range(len(os.listdir(path_i))):
    ...
    while u_completed == False:
        ...
        time.sleep(6)
        pyautogui.typewrite('Vehicle')
        time.sleep(0.5)
        pyautogui.click(339, 283) #click at TimeCard
        validation = wait_for_confirmation('Vehicle', 273, 246, 357, 264, time_out=10)
        if validation == False:
            reload(True)
            continue
        time.sleep(1)
        ...
        pyautogui.click(673, 444) #chage the shop field
        pyautogui.typewrite('unique id')
        time.sleep(1.5)
        pyautogui.click(654, 481)
        time.sleep(1)
