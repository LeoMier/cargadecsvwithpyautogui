...
path_i = r'C:\Users\JF_db\Desktop\database\vendors\Data\upload'
path_f = r'C:\Users\JF_db\Desktop\database\vendors\Data\done'
...
for _ in range(len(os.listdir(path_i))):
    ...
    while u_completed == False:
        ...
        time.sleep(6)
        pyautogui.typewrite('Vendor')
        time.sleep(0.5)
        pyautogui.click(339, 283) #click at TimeCard
        validation = wait_for_confirmation('Vendor', 273, 246, 357, 264, time_out=10)
        if validation == False:
            reload(True)
            continue
        time.sleep(1)
