...
path_i = r'C:\Users\JF_db\Desktop\database\employees\Data\upload'
path_f = r'C:\Users\JF_db\Desktop\database\employees\Data\done'
...
for _ in range(len(os.listdir(path_i))):
    ...
    while u_completed == False:
        ...
        validation = wait_for_confirmation('Employee', 273, 246, 371, 264, time_out=10)
        if validation == False:
            reload(True)
            continue
        time.sleep(1)
        ...
        pyautogui.click(671, 410) #chage the shop field
        pyautogui.typewrite('migratio')
        time.sleep(1.5)
        pyautogui.click(668, 445)
        time.sleep(1)

        pyautogui.click(671, 445) #chage the shop field
        pyautogui.typewrite('unique id')
        time.sleep(1.5)
        pyautogui.click(668, 486)
        time.sleep(1)

        pyautogui.click(809, 445) #chage the shop field
        pyautogui.typewrite(',')
        time.sleep(1.5)
        pyautogui.click(809, 486)
        time.sleep(1)

        pyautogui.click(671, 486) #chage the shop field
        pyautogui.typewrite('migratio')
        time.sleep(1.5)
        pyautogui.click(668, 525)
        time.sleep(1)
