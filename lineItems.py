...
path_i = r'C:\Users\JF_db\Desktop\database\lineItems\Data\upload'
path_f = r'C:\Users\JF_db\Desktop\database\lineItems\Data\done'
...
for _ in range(len(os.listdir(path_i))):
    ...
    while u_completed == False:
        ...
        validation = wait_for_confirmation('lineltems', 273, 246, 416, 264, time_out=10)
        if validation == False:
            reload(True)
            continue
        time.sleep(1)
