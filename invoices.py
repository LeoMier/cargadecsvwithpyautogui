...
path_i = r'C:\Users\JF_db\Desktop\database\invoices\Data\upload'
path_f = r'C:\Users\JF_db\Desktop\database\invoices\Data\done'
...
for _ in range(len(os.listdir(path_i))):
    ...
    while u_completed == False:
        ...
        time.sleep(6)
        pyautogui.typewrite('Invoice/Estimate')
        time.sleep(0.5)
        pyautogui.click(339, 283) #click at TimeCard
        validation = wait_for_confirmation('Invoice/Estimate', 273, 246, 416, 264, time_out=10)
        if validation == False:
            reload(True)
            continue
        time.sleep(1)
        ...
        pyautogui.click(671, 406) #chage the shop field
        pyautogui.typewrite('unique id')
        time.sleep(1.5)
        pyautogui.click(668, 444)
        time.sleep(1)

        pyautogui.click(668, 444) #chage the shop field
        pyautogui.typewrite('migratio')
        time.sleep(1.5)
        pyautogui.click(668, 492)
        time.sleep(1)

        pyautogui.click(640, 492) #chage the shop field
        pyautogui.typewrite('unique id')
        time.sleep(1.5)
        pyautogui.click(640, 525)
        time.sleep(1)
        ...
        validation = wait_for_confirmation('Done', 201, 270, 251, 288, time_out=180)
        if validation == False:
            reload(True)
            continue
