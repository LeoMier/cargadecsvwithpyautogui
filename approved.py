...
path_i = r'C:\Users\JF_db\Desktop\database\approved\Data\upload'
path_f = r'C:\Users\JF_db\Desktop\database\approved\Data\done'
...
for _ in range(len(os.listdir(path_i))):
    ...
    while u_completed == False:
        ...
        time.sleep(6)
        pyautogui.typewrite('ApprovedTimeCards')
        time.sleep(0.5)
        pyautogui.click(339, 283) #click at TimeCard
        validation = wait_for_confirmation('ApprovedTimeCards', 273, 246, 416, 264, time_out=10)
        if validation == False:
            reload(True)
            continue
        time.sleep(1)
        ...
        time.sleep(0.5)
        pyautogui.click(654,481) #click on blank 
        pyautogui.hotkey('end') #scroll down
        time.sleep(1)

        pyautogui.click(671, 367) #chage the shop field
        pyautogui.typewrite('unique id')
        time.sleep(1.5)
        pyautogui.click(668, 405)
        time.sleep(1)

        pyautogui.click(809, 367) #chage the shop field
        pyautogui.typewrite(',')
        time.sleep(1.5)
        pyautogui.click(809, 405)
        time.sleep(1)

        pyautogui.click(668, 405) #chage the shop field
        pyautogui.typewrite('migratio')
        time.sleep(1.5)
        pyautogui.click(668, 449)
        time.sleep(1)

        pyautogui.click(640, 449) #chage the shop field
        pyautogui.typewrite(';')
        time.sleep(1.5)
        pyautogui.click(640, 492)
        time.sleep(1)

        pyautogui.click(668, 492) #chage the shop field
        pyautogui.typewrite('unique id')
        time.sleep(1.5)
        pyautogui.click(668, 530)
        time.sleep(1)
